...
class UpdateFlightPathCommandParser(CommandParser):
    ...
    def BuildCommandArgs(self, parser):
        ...
        parser.add_argument("-t","-toId","--toDestinationId", type=int, help="The Arrival Destination Id for the FlightPath")
        parser.add_argument("-tc","-toCode","--toDestinationAirportCode", type=str, help="The Arrival Destination Airport Code for the FlightPath")
